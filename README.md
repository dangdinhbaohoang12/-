...
> ⚠️ **Lưu ý an toàn:** Đây là phần mềm đang phát triển và **không tự động trở thành hệ thống PTW production hoặc nguồn dữ liệu an toàn duy nhất**. Trước khi sử dụng thực tế phải triển khai, kiểm định, cấu hình và phê duyệt theo quy trình HSE/IT của đơn vị vận hành. Các ngưỡng Gas Test và workflow trong mã nguồn là cấu hình của repository, không phải tuyên bố rằng chúng phù hợp cho mọi giàn hoặc quy chuẩn.
